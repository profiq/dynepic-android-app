...
public final class Configuration {
    ...
    private Uri mProfilePictureEndpointUri;
    ...
    @Nullable
    public Uri mProfilePictureEndpointUri() {
        return mProfilePictureEndpointUri;
    }
    ...
    private void readConfiguration() throws InvalidConfigurationException {
        ...
        // TODO don't use it in production from config file
        ...
        if (getConfigString("discovery_uri") == null) {
            ...
            mProfilePictureEndpointUri = getRequiredConfigWebUri("profile_picture_endpoint_uri");
